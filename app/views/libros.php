...
<head>
    ...
    <link rel="stylesheet" href="<?php echo URL;?>public_html/css/pantallas.css">
        ...
        <div id="contentList" class="mt-3">
            <h4>
                <i class="bi bi-book-half"></i>
                    Libros<button type="button" class="" id="btnAgregar">
            ...
            <div class="busqueda">
                <div class="col-md-4">
                    <div class="input-group mb-3">
                        <input type="search" class="form-control busquedainput"  aria-describedby="basic-addon2" id="txtSearch">
